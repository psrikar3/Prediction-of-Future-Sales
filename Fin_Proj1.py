...
# # DATA ANALYTICS WITH R - Final Project: Predict Future Sales

# ### TEAM MEMBERS :
# #### NAME : BALA KIRAN PILLEM 
# #### UCID : bp483
# #### Email: bp483@njit.edu
#  CONTRIBUTION : DID THE EXPLORATORY DATA ANALYSIS, CREATED MACHINE LEARNING MODEL LGBM REGRESSOR MODEL AND HELPED IN DOING PPT.
#  
# #### NAME : SRITANVI THIRUNAGARI
# #### UCID : st868
# #### EMAIL: st868@njit.edu
#  CONTRIBUTION : DID FEATURE ENGINEERING,COMPARED ALL THE GRAPHICAL VALUES EXPLORING THE TRAINING DATA SET AND HELPED IN DOING PPT
#  
# #### NAME : SATYA SURYA KESAVA SRIKAR PALIVELA
# #### UCID :sp2878 
# #### EMAIL:sp2878@njit.edu
#  CONTRIBUTION :  DID READING EACH AND EVERY DATASET, COMAPARISON BETWEEN TWO MODELS AND GIVING PRESENTATION IN THE CLASS.
#  
# #### NAME : GORRIPATI MOHAN CHANDRA SATYA BALAYOGI
# #### UCID : mg876
# #### EMAIL:mg876@njit.edu
#  CONTRIBUTION : CRAETED ANOTHER MODEL XGBoost, DID COMAPRISON BETWEEN TWO MODELS AND HELPED IN PPT
